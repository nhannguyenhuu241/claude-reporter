...
class TestTemplateRendering:
    ...
    def test_index_template_rendering(self):
        ...
        # Note: summary div only appears when token_summary or formatted_time_range exist
        assert "stats-grid" in index_html  # Stats grid is always shown
    ...
    def test_html_escaping(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            assert (
                "<script>" not in html_content or html_content.count("<script>") <= 3
            )  # Allow for the markdown script, search script, and timeline script
